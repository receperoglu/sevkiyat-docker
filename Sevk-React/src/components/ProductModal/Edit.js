...
export default function Edit() {
  ...
  const { ShowProductEdit, Order, ProductTypes, Loading } = state;
      ...
      <div className="root-345">
        <div className="ms-Dialog-main  main-412">
          ...
          <div className="clearfix OrderRow">
            ...
            <div className="col-md-12 fleft">
              <CreateOption Json={ProductTypes} name="ProductType" val={Order.ProductTypeId} />
            </div>
            <div className="col-md-12 fleft">
              <span>Adet</span>
            </div>
            ...
            <div className="col-md-12 text-center fleft">
              ...
              {!Loading && <BlueButton text="Güncelle" click={UpdateOrder} />}
            </div>
          </div>
          <hr />
        </div>
